	...
	return /* @__PURE__ */ (0, b.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, b.jsxs)(Rn, {
				...
				children: [/* @__PURE__ */ (0, b.jsx)(zn, { src: "https://github.com/shadcn.png" }), /* @__PURE__ */ (0, b.jsx)(Bn, { children: "👤" })]
			}),
...
function Kn(e, t) {
	...
	for (let e of n) {
		...
		let n = e.textContent?.trim().match(Un);
		if (!n) continue;
		let [, r, i] = n, a = document.createElement("span");
		a.className = "cx-dialogue-shadow-host";
		...
		let c = e.innerHTML;
		e.replaceChildren(a);
		let l = (0, y.createRoot)(s);
		l.render(/* @__PURE__ */ (0, b.jsx)(Hn, {
			speaker: r.trim(),
			content: i.trim()
		})), Wn.set(e, {
			root: l,
...
function qn(e, t) {
	let n = retrieveDisplayedMessage(e)[0];
	n && Kn(n, t);
}
function Jn(e) {
	$(".mes_text").each((t, n) => {
